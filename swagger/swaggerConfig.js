...
const options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description: "API documentation for the Task Management system including tasks, teams, notifications, comments and activities",
    },
    servers: [
      {
      ...
      schemas: {
          ...
          properties: {
            ...
            type: {
              ...
              enum: [
                ...
                "task_status_changed", "team_invite", "team_join_request",
                "team_join_accepted", "team_join_rejected",
                "team_member_added", "team_member_removed", "comment_added",
              ],
            },
        ...
        Activity: {
          ...
          properties: {
            ...
            task:      { $ref: "#/components/schemas/Task" },
            user:      { $ref: "#/components/schemas/User" },
            action:    { type: "string", enum: ["created", "updated", "deleted", "commented", "assigned"] },
